...
<section class="home">
   ...
   <div class="swiper home-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide" style="background:url(images/download.jpg) no-repeat">
            <div class="content">
         ...
         <div class="swiper-slide slide" style="background:url(images/download\ \(1\).jpg) no-repeat">
            <div class="content">
         ...
         <div class="swiper-slide slide" style="background:url(images/download\ \(2\).jpg) no-repeat">
            <div class="content">
               <h3>plan your wedding!</h3>
               <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Impedit, obcaecati quos. Minima eius qui id quas atque corporis, quia nulla.</p>
               <a href="about.php" class="btn">discover more</a>
